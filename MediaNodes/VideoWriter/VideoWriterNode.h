#ifndef VIDEO_WRITER_NODE_H
#define VIDEO_WRITER_NODE_H
...
const int32 MAX_ALLOWED_INSTANCES_VWR			= 5;

/*#define INFO printf
#define DEBUG printf
#define ERROR printf*/

class VideoWriterNode :	public BBufferConsumer,
...
public:
						VideoWriterNode(BMediaAddOn *mediaAddon, const char *name, int32 internal_id);
						~VideoWriterNode();
...
public:
	...
	uint64				CountFrames(void){return countFrames;};
