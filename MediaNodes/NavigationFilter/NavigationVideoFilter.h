#ifndef NAVIGATIONS_VIDEO_FILTER_H
#define NAVIGATIONS_VIDEO_FILTER_H
...
class NavigationVideoFilter :			public BBufferProducer,
								public BBufferConsumer,
								public BMediaEventLooper,
								public BControllable
{
public:
				NavigationVideoFilter(BMediaAddOn *addon,	const char *name, int32 internal_id);
				~NavigationVideoFilter();
...
//---------------------------BControllable-----------------------//
	...
	inline	void		CalcInt16(int16 *inputData,int16* outputData, uint32 size);
	inline	void		CalcInt8(int8 *inputData,int8* outputData, uint32 size);

	inline	void		NoCalc(uint32 *inputData,uint32* outputData,uint32 size);
...
//+++++++++++++++++++++++++++BControllable+++++++++++++++++++++++//
			BParameterWeb			*web;
			BContinuousParameter	*xPos;
			BContinuousParameter	*yPos;
			BContinuousParameter	*xSpeed;
			BContinuousParameter	*ySpeed;
